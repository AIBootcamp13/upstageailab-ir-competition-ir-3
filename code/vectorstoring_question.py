...
with open("../data/documents_question.jsonl", "r", encoding="utf-8") as f:
...
lc_docs = [
    Document(page_content=" ".join(d["questions"]), metadata={"docid": d["docid"]})
    for d in docs
]
...
vectorstore.save_local("faiss_index_question") 
